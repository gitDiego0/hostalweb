...
export default function Footer() {
  return (
    <footer className="pv4 ph3 ph5-ns tc">
      <Link className="link dim gray dib h2 w2 br-100 mr3 " to="#">
      ...
      <Link className="link dim gray dib br-100 h2 w2 mr3 " to="#">
      ...
      <div className="mt4">
        <Link to="#" className="f6 link dim gray dib mr3 mr4-ns">
          Help
        </Link>
        <Link to="#" className="f6 link dim gray dib mr3 mr4-ns">
          Send feedback
        ...
        <Link to="#" className="f6 link dim gray dib">
          Terms
        </Link>
      </div>
    </footer>
